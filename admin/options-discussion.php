...
<main class="flex-1 flex flex-col overflow-hidden bg-discord-light">
    ...
    <header class="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-6 z-10">
        <div class="flex items-center text-discord-muted">
            ...
            <i class="fas fa-comment-dots mr-2 hidden md:inline"></i>
            <span class="mx-2 hidden md:inline">/</span>
            <span class="font-medium text-discord-text"><?php _e('设置'); ?></span>
            <span class="mx-2 hidden md:inline">/</span>
            <span class="font-medium text-discord-text"><?php _e('评论设置'); ?></span>
        </div>
    ...
    <div class="flex-1 overflow-y-auto p-4 md:p-8">
        <div class="w-full max-w-none mx-auto">
            ...
            <div class="flex bg-white select-none overflow-x-auto settings-tabs">
                ...
                <a href="<?php $options->adminUrl('options-discussion.php'); ?>" class="flex-1 text-center px-4 py-3 text-sm font-medium transition-all active"><?php _e('评论设置'); ?></a>
